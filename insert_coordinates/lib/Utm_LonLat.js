/**
     ...
     *
     * Parameters:
     * obj - object type GEOR.Addons.Insert_Coordinates.prototype
     * x - longitude
     * y - latitude
     * z - zone
     * namepoint - name or title of the coordinate
     */

function utm(obj,x,y,z,namepoint){
    ...
    var southhemi=true; //if your southern hemisphere coordinate is then true else false
    
    var latlon=new Array(2); // array where our result will be stored latitude and longitude
    ...
    function MapXYToLatLon (x, y, lambda0, philambda)
    {
        ...
        obj.valid_limits(lon,lat,namepoint);
        return;
    }
